...
export default function ViewCarsTableComponent() {
  ...
  const handleRowAdd = (newData, resolve) => {
    Axios.post('localhost:8080/app/cars/add-a-car', newData)
      .then(res => {
  ...
  const handleRowUpdate = (newData, oldData, resolve) => {
    Axios.put(`localhost:8080/app/cars/car/${oldData.carid}`,newData)
      .then(res => {
  ...
  const handleRowDelete = (oldData, resolve) => {
    ...
    Axios.delete(`localhost:8080/app/cars/car/${oldData.carid}`)
      .then(res => {
