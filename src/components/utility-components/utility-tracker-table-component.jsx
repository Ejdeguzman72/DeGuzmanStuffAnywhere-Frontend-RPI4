...
export default function UtilityTableComponent() {
    ...
    const handleRowAdd = (newData, resolve) => {
        Axios.post(`localhost:8080/app/utility-information/add-utility-information`, newData)
        .then(res => {
            console.log(newData);
    ...
    const handleRowDelete = (oldData, resolve) => {
        Axios.delete(`localhost:8080/app/utility-information/utility/${oldData.utilityid}`)
        .then(res => {
    ...
    const handleRowUpdate = (newData,oldData,resolve) => {
        Axios.put(`localhost:8080/app/utility-information/utility/${oldData.utilityid}`)
        .then(res => {
            console.log(oldData.utilityid);
