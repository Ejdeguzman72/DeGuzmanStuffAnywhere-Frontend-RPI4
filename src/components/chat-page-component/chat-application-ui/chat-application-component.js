...
import DeGuzmanStuffAnywhereChatApplicationTab from '../../tab-components/DeGuzmanStuffanywhereChatTab';
    ...
    render() {
        return (
            <div id="white-background">
                <DeGuzmanStuffAnywhereChatApplicationTab />
                <br></br>
                ...
                <SockJsClient url='http://192.168.1.36:8080/websocket-chat'
                    topics={['/topic/user']}
                    onConnect={() => {
