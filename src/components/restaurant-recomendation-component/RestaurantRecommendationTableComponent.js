...
export default function RestaurantRecommendationTableComponent() {
  ...
  const handleRowAdd = (newData, resolve) => {
    Axios.post('http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/restaurants/add-restaurant-information', newData)
      .then(res => {
  ...
  const handleRowUpdate = (newData, oldData, resolve) => {
    Axios.put(`http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/restaurants/update-restaurat/${oldData.restaurant_id}`)
      .then(res => {
  ...
  const handleRowDelete = (oldData, resolve) => {
    ...
    Axios.delete(`http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/restaurants/delete-restaurant/${oldData.restaurant_id}`)
      .then(res => {
