...
const api = Axios.create({
  baseURL: 'http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/general-transactions'
});
...
export default function GeneralFinancePageTableComponent() {
  ...
  const handleRowUpdate = (newData, oldData, resolve) => {
    ...
    Axios.put(`http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/general-transaction/transaction/${newData.transactionId}`, newData)
      .then(res => {
  ...
  const handleRowDelete = (oldData, resolve) => {
    ...
    Axios.delete(`http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/general-transaction/transaction/${oldData.transactionId}`)
      .then(res => {
  ...
  const handleRowAdd = (newData, resolve) => {
    Axios.post("http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/general-transaction/add-transaction-information", newData)
      .then(res => {
