...
export default function MedicalFinancePageTableComponent() {
  ...
  const handleRowAdd = (newData, resolve) => {
    Axios.post('http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/medical-transactions/add-medical-transaction', newData)
      .then(res => {
  ...
  const handleRowUpdate = (newData, oldData, resolve) => {
    Axios.put(`http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/medical-transactions/medical-transaction/${oldData.medicalTransactionId}`)
      .then(res => {
  ...
  const handleRowDelete = (oldData, resolve) => {
    Axios.delete(`http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/medical-transactions/medical-transaction/${oldData.medicalTransactionId}`)
      .then(res => {
