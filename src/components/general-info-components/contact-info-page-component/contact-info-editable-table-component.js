...
export default function ContactInfoEditableTableComponent() {
  ...
  const handleRowAdd = (newData,resolve) => {
    ...
    Axios.post('http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/person-info/add-person-information', newData)
    .then(res => {
      console.log(newData);
  ...
  const handleRowDelete = (oldData, resolve) => {
    Axios.delete(`http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/person-info/person/${oldData.personid}`)
    .then(res => {
  ...
  const handleRowUpdate = (newData,oldData,resolve) => {
    Axios.put(`http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/person-info/person/${oldData.personid}`,newData)
    .then(res => {
      console.log(newData);
