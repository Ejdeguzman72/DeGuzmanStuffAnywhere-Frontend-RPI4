...
export default function AdminPortalPendingUsersTableComponent() {
  ...
  const handleRowUpdate = (newData, oldData, resolve) => {
    ...
    Axios.put(`http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/users/${newData.userid}`, newData)
      .then(res => {
  ...
  //   Axios.delete(`http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/users/${oldData.userid}`)
  //     .then(res => {
