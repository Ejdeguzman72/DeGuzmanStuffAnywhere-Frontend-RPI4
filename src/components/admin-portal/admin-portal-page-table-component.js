...
import UserService from '../../services/users-info-service';
...
const api = Axios.create({
  baseURL: 'http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/users'
});
...
export default function AdminPortalPageUserTableComponent() {
  ...
  const handleRowUpdate = (newData, oldData, resolve) => {
    ...
    Axios.put(`http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/users/${newData.user_id}`, newData)
      .then(res => {
  ...
  const handleRowDelete = (oldData, resolve) => {
    ...
    Axios.delete(`http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/users/${oldData.user_id}`)
      .then(res => {
  ...
  const handleRowAdd = (newData, resolve) => {
    Axios.post("http://ec2-54-162-1-238.compute-1.amazonaws.com:8080/app/users/add-user-information", newData)
      .then(res => {
